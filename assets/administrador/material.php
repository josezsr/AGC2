                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <TR>
                                                ...
                                                <td><a href="modificar/modificar1.php?idmaterial=<?php echo $row['idmaterial']; ?>"><button class=" waves-effect waves-color btn-small" type="submit">Modificar</button></a></td>
                                                <td><a href="eliminar/eliminar1.php?idmaterial=<?php echo $row['idmaterial']; ?>"><button class=" waves-effect waves-color btn-small" type="submit">Eliminar</button></td>
                                            </TR>
                                    </tbody>
                                <?php
                                        }
