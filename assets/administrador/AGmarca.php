...
<nav class="navbar navbar-expand-sm  navbar-dark " style="background-color: #1537B3;" >
		...
		<div class="container">
				<div class="row">
					<h1 style="text-align:center">Agregar nueva marca</h1>

				</div>
			<form class="form-horizontal"  method="POST" action="../modulos/marca.php" >
				
				<label class="form-group" for="marca" class="col-sm-2 control-label"  >marca</label>
				<div class="col-sm-10" > 
					<input type="text" name="nombre" class="form-control" id="nombre"  placeholder="marca" ><br>
				</div>
