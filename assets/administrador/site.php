...
<body>
    <nav class="navbar navbar-expand-sm  navbar-dark " style="background-color: #1537B3;" >
		<a class="navbar-brand" href="panelA.php">
 		...
 		<div class="collapse navbar-collapse" id="navbarSupportedContent">
  			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item active">
					<a class="nav-link" href="usuarios.php">Ususarios</a>
				</li>
				<li class="nav-item active">
     ...
     <section class="main">
                   ...
                   <div class="collapsible-header text-center">Site</div>
                                   ...
                                   <tbody class="pt-9">
                                       ...
                                       ?>
                                           <TR>
                                               ...
                                               <td><a href="modificar/modificar3.php?idsite=<?php echo $row['idsite']; ?>"><button class=" waves-effect waves-color btn-small" type="submit">Modificar</button></a></td>
                                               <td><a href="eliminar/eliminar3.php?idsite=<?php echo $row['idsite']; ?>"><button class=" waves-effect waves-color btn-small" type="submit">Eliminar</button></td>
                                           </TR>
                                   </tbody>
                               <?php
                                       }
