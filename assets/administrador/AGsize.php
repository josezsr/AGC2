...
<body>
 ...
 <nav class="navbar navbar-expand-sm  navbar-dark " style="background-color: #1537B3;" >
	...
	<div class="container">
	<div class="row">
		<h1 style="text-align:center">Agregar nuevo tamaño</h1>

	</div>
	<form class="form-horizontal" method="POST" action="modulos/size.php" autocoplete="off" >
        <div class="form-group">
		<label class="col-sm-2 control-label">tamaño</label>
			<div>
				<input class="form-control" type="text" name="tamaño" placeholdeer="nuevo tamaño" require><br>
			</div>
        </div><br>
